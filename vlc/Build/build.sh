...
#! /bin/sh
spectool -R -g -f ~/rpmbuild/SPECS/vlc.spec
yum-builddep -y ~/rpmbuild/SPECS/vlc.spec
...
sed -i -e '/%files/r /tmp/FILES.LOG' /root/rpmbuild/SPECS/vlc.spec; sed -i -e '/%files devel/r /tmp/DEVEL_FILES.LOG' /root/rpmbuild/SPECS/vlc.spec
